...
public class SingleUserExpandableListAdapter extends BaseExpandableListAdapter {

    HashMap<String, List<String>> listHashMap;
    String[] listNames;

    public SingleUserExpandableListAdapter(HashMap<String, List<String>> listHashMap) {
